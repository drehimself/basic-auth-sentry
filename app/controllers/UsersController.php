...
class UsersController extends \BaseController {
	...
	public function update($id)
	{
		...
		if (! Input::has("password"))
		{
			...
			return Redirect::route('profiles.edit', $user->id)->withFlashMessage('User has been updated!');
		}
		...
		else
		{
			...
			return Redirect::route('profiles.edit', $user->id)->withFlashMessage('User (and password) has been updated!');
